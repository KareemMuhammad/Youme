...
class ProfileDiariesWidget extends StatelessWidget {
  final Diaries diary;
  final UserProvider userProvider;
  final DiaryProvider diaryProvider;

  const ProfileDiariesWidget({Key key, this.diary, this.userProvider, this.diaryProvider}) : super(key: key);
  @override
    ...
    return Column(
      children: [
        ListTile(
          ...
          title: Text('${userProvider.getUser.name}',style: TextStyle(color: textColor,fontSize: 17,letterSpacing: 1,),),
          ...
          trailing: IconButton(
              ...
              onPressed: (){
                showModalBottomSheet(context: context, builder: (context){
                  return diary.userId == userProvider.getUser.id ? ProfileCustomSheet(diaryProvider: diaryProvider,youMeProvider: userProvider,diary: diary,)
                      : CustomSheet(diaryProvider: diaryProvider,userProvider: userProvider,diary: diary,);
                });
              }),
        ),
        ...
        Padding(
          padding: const EdgeInsets.all(8.0),
          child: Divider(height: 1,color: icons,),
        ),
      ],
    );
  }
